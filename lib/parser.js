...
module.exports = function (src) {
    ...
    var spaceRegEx = /^[ \t\r\n\b\f]+/,
        ...
        openSquareBracketRegEx = /^\[/,
        closingSquareBracketRegEx = /^\]/,
        operatorRegEx = /^(\*|\+|\-|\/|\%|\=)/,
        unaryOperatorRegEx = /^(\!)/,
    ...
    var spaceParser = consumer(spaceRegEx, function (val) {
        ...
        openSquareBracketParser = consumer(openSquareBracketRegEx, function (val) {
            return true
        }),
        closingSquareBracketParser = consumer(closingSquareBracketRegEx, function (val) {
            return true
        }),
    ...
    function binaryExpressionParser() {
        ...
        return combinator({type: "BinaryExpression"}, ["operator", operatorParser], ["left", argStatementParser], ["right", argStatementParser], ["", closingParanthesesParser])
    }
    function arrayExpressionParser() {
        // console.info("arrayExpressionParser "+src)
        if (!openSquareBracketParser())   return null
        return combinator({type: "ArrayExpression"}, ["elements", argumentsParser], ["", closingSquareBracketParser], ["", closingParanthesesParser()])
    }
    ...
    function ifStatementParser() {
        ...
        var rest = src.slice(snippet.length)
        src = snippet
        var expr = combinator({type: "IfStatement"}, ["test", argStatementParser], ["", openParanthesesParser], ["consequent", blockStatementParser], ["", openParanthesesParser], ["alternate", blockStatementParser])
        src = rest
        return expr
    }
    ...
    function statementParser() {
        ...
        return commentParser() || arrayExpressionParser() || ifStatementParser() || arrowFunctionParser() || macroDeclarationParser()|| functionDeclarationParser() || variableDeclarationParser() || elementParser() || macroCallParser() || expressionStatementParser()
    }

    function argStatementParser() {
        // console.info("argStatementParser "+src)
        return commentParser() || arrayExpressionParser() || ifStatementParser() || arrowFunctionParser() || macroDeclarationParser()|| functionDeclarationParser() || variableDeclarationParser() || elementParser() || macroCallParser() || expressionParser()
    }
