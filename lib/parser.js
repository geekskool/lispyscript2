...
module.exports = function(src) {
    ...
    var statementParser = parserFactory(commentParser, arrayExpressionParser, objectExpressionParser, ifStatementParser, arrowFunctionParser, functionDeclarationParser, variableDeclarationParser, elementParser, expressionStatementParser),

        argStatementParser = parserFactory(commentParser, arrayExpressionParser, objectExpressionParser, ifStatementParser, arrowFunctionParser, functionDeclarationParser, variableDeclarationParser, elementParser, expressionParser)
