...
var filename = testFile.slice(0,/\.ls2$/.exec(testFile).index);

// Creating new folder and populating it with the generated files - nikhil
mkdir(`${process.cwd()}/${filename}`, (err) => {
	...
	// evaluating the generated js file
	var output = eval(js)
